...
class RAGClient:
    ...
    def __init__(self, db_url: str, embedding_model: Embeddings):
        """
        初始化 RAG 客户端
        :param db_url: PostgreSQL 连接字符串
        :param embedding_model: 向量化模型（LangChain Embeddings）
        """
    ...
    def search(self, query: str, knowledge_id_list: List[str],
               ...
               search_mode: SearchMode = SearchMode.EMBEDDING) -> List[Dict]:
        """
        检索知识库
        :param query: 查询文本
